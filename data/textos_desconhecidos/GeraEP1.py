...
def enc_monosyllabic(conteudo, tamanho, grupo):
    ...
    save_file(
        "Cifrado/Mono/" + grupo + "_" + "texto_cifrado.txt", "".join(texto_cifrado)
    )
...
def enc_hill(conteudo, tamanho, grupo, k):
    ...
    save_file(
        "Cifrado/Hill/" + grupo + "_" + str(k) + "_" + "texto_cifrado.txt",
        "".join(texto_cifrado),
    )
    save_file(
        "Aberto/Hill/" + grupo + "_" + str(k) + "_" + "key.txt", np.array2string(key)
    )
    save_file(
        "Aberto/Hill/" + grupo + "_" + str(k) + "_" + "texto_aberto.txt",
        "".join(texto_aberto),
    )
...
def enc_vigenere(conteudo, tamanho, grupo, k):
    ...
    save_file(
        "Cifrado/Vigenere/" + grupo + "_" + str(k) + "_" + "texto_cifrado.txt",
        "".join(texto_cifrado),
    )
    save_file(
        "Aberto/Vigenere/" + grupo + "_" + str(k) + "_" + "key.txt", "".join(key_texto)
    )
    save_file(
        "Aberto/Vigenere/" + grupo + "_" + str(k) + "_" + "texto_aberto.txt",
        "".join(texto_aberto),
    )
